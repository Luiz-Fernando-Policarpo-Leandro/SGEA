...
const public_route_1 = __importDefault(require("../../presentation/routes/public.route"));
const router = (0, express_1.Router)();
// Repositories (infrastructure)
const usuarioRepository = new usuario_repository_1.UsuarioRepository();
const participanteRepository = new participante_repository_1.ParticipanteRepository();
const coordenadorRepository = new coordenador_repository_1.CoordenadorRepository();
const administradorRepository = new administrador_repository_1.AdministradorRepository();
...
const certificadoRepository = new certificado_repository_1.CertificadoRepository();
...
router.use('/api', (0, participante_route_1.createParticipanteRouter)(participanteRepository));
router.use('/api', (0, coordenador_route_1.createCoordenadorRouter)(coordenadorRepository));
router.use('/api', (0, administrador_route_1.createAdministradorRouter)(administradorRepository));
router.use('/api', (0, evento_route_1.createEventoRouter)(eventoRepository));
router.use('/api', (0, atividade_route_1.createAtividadeRouter)(atividadeRepository));
router.use('/api', (0, inscricao_route_1.createInscricaoRouter)(inscricaoRepository));
router.use('/api', (0, certificado_route_1.createCertificadoRouter)(certificadoRepository));
router.use('/api', (0, presenca_route_1.createPresencaRouter)(presencaRepository));
