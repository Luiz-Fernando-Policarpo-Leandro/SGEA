...
class CoordenadorController {
  ...
  create = async (req, res) => {
    try {
      const useCase = new coordenador_use_cases_1.CreateCoordenadorUseCase(
        this.repository,
      );
  ...
  list = async (req, res) => {
    try {
      const useCase = new coordenador_use_cases_1.ListCoordenadoresUseCase(
        this.repository,
      );
  ...
  get = async (req, res) => {
    try {
      const useCase = new coordenador_use_cases_1.GetCoordenadorUseCase(
        this.repository,
      );
  ...
  remove = async (req, res) => {
    try {
      const useCase = new coordenador_use_cases_1.DeleteCoordenadorUseCase(
        this.repository,
      );
