...
class CertificadoController {
    ...
    create = async (req, res) => {
        try {
            const useCase = new certificado_use_cases_1.CreateCertificadoUseCase(this.repository);
    ...
    list = async (req, res) => {
        try {
            const useCase = new certificado_use_cases_1.ListCertificadosUseCase(this.repository);
    ...
    listByParticipante = async (req, res) => {
        try {
            const useCase = new certificado_use_cases_1.ListCertificadosByParticipanteUseCase(this.repository);
    ...
    get = async (req, res) => {
        try {
            ...
            const useCase = new certificado_use_cases_1.GetCertificadoUseCase(this.repository);
    ...
    update = async (req, res) => {
        try {
            const codigo = String(req.params.codigo);
            const useCase = new certificado_use_cases_1.UpdateCertificadoUseCase(this.repository);
    ...
    remove = async (req, res) => {
        try {
            const codigo = String(req.params.codigo);
            const useCase = new certificado_use_cases_1.DeleteCertificadoUseCase(this.repository);
