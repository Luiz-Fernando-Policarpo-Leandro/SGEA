...
class ParticipanteController {
  ...
  create = async (req, res) => {
    try {
      const useCase = new participante_use_cases_1.CreateParticipanteUseCase(
        this.repository,
      );
  ...
  list = async (req, res) => {
    try {
      const useCase = new participante_use_cases_1.ListParticipantesUseCase(
        this.repository,
      );
  ...
  get = async (req, res) => {
    try {
      const useCase = new participante_use_cases_1.GetParticipanteUseCase(
        this.repository,
      );
  ...
  update = async (req, res) => {
    try {
      const useCase = new participante_use_cases_1.UpdateParticipanteUseCase(
        this.repository,
      );
  ...
  remove = async (req, res) => {
    try {
      const useCase = new participante_use_cases_1.DeleteParticipanteUseCase(
        this.repository,
      );
