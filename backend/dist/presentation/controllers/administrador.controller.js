...
class AdministradorController {
  ...
  create = async (req, res) => {
    try {
      const useCase = new administrador_use_cases_1.CreateAdministradorUseCase(
        this.repository,
      );
  ...
  list = async (req, res) => {
    try {
      const useCase = new administrador_use_cases_1.ListAdministradoresUseCase(
        this.repository,
      );
  ...
  get = async (req, res) => {
    try {
      const useCase = new administrador_use_cases_1.GetAdministradorUseCase(
        this.repository,
      );
  ...
  remove = async (req, res) => {
    try {
      const useCase = new administrador_use_cases_1.DeleteAdministradorUseCase(
        this.repository,
      );
