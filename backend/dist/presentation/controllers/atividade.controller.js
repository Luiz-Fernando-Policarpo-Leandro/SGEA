...
class AtividadeController {
  ...
  create = async (req, res) => {
    try {
      const useCase = new atividade_use_cases_1.CreateAtividadeUseCase(
        this.repository,
      );
  ...
  list = async (req, res) => {
    try {
      const useCase = new atividade_use_cases_1.ListAtividadesUseCase(
        this.repository,
      );
  ...
  listByEvento = async (req, res) => {
    try {
      const useCase = new atividade_use_cases_1.ListAtividadesByEventoUseCase(
        this.repository,
      );
  ...
  get = async (req, res) => {
    try {
      const useCase = new atividade_use_cases_1.GetAtividadeUseCase(
        this.repository,
      );
  ...
  update = async (req, res) => {
    try {
      const useCase = new atividade_use_cases_1.UpdateAtividadeUseCase(
        this.repository,
      );
  ...
  remove = async (req, res) => {
    try {
      const useCase = new atividade_use_cases_1.DeleteAtividadeUseCase(
        this.repository,
      );
