...
class InscricaoController {
  ...
  create = async (req, res) => {
    try {
      const useCase = new inscricao_use_cases_1.CreateInscricaoUseCase(
        this.repository,
      );
  ...
  list = async (req, res) => {
    try {
      const useCase = new inscricao_use_cases_1.ListInscricoesUseCase(
        this.repository,
      );
  ...
  listByParticipante = async (req, res) => {
    try {
      const useCase =
        new inscricao_use_cases_1.ListInscricoesByParticipanteUseCase(
          this.repository,
        );
  ...
  listByEvento = async (req, res) => {
    try {
      const useCase = new inscricao_use_cases_1.ListInscricoesByEventoUseCase(
        this.repository,
      );
  ...
  get = async (req, res) => {
    try {
      const useCase = new inscricao_use_cases_1.GetInscricaoUseCase(
        this.repository,
      );
  ...
  update = async (req, res) => {
    try {
      const useCase = new inscricao_use_cases_1.UpdateInscricaoUseCase(
        this.repository,
      );
  ...
  remove = async (req, res) => {
    try {
      const useCase = new inscricao_use_cases_1.DeleteInscricaoUseCase(
        this.repository,
      );
