...
class EventoController {
  ...
  create = async (req, res) => {
    try {
      const useCase = new evento_use_cases_1.CreateEventoUseCase(
        this.repository,
      );
  ...
  list = async (req, res) => {
    try {
      const useCase = new evento_use_cases_1.ListEventosUseCase(
        this.repository,
      );
  ...
  update = async (req, res) => {
    try {
      const useCase = new evento_use_cases_1.UpdateEventoUseCase(
        this.repository,
      );
  ...
  remove = async (req, res) => {
    try {
      const useCase = new evento_use_cases_1.DeleteEventoUseCase(
        this.repository,
      );
