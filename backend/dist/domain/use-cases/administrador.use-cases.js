...
exports.DeleteAdministradorUseCase = exports.GetAdministradorUseCase = exports.ListAdministradoresUseCase = exports.CreateAdministradorUseCase = void 0;
class CreateAdministradorUseCase {
    ...
    async execute(data) {
        ...
        if (exists)
            throw new Error("Administrador ja cadastrado");
