...
export declare class GetPresencaUseCase {
    private repository;
    constructor(repository: IPresencaRepository);
    execute(participante_id: number, atividade_id: number): Promise<Presenca | null>;
}
...
export declare class UpdatePresencaUseCase {
    private repository;
    constructor(repository: IPresencaRepository);
    execute(participante_id: number, atividade_id: number, data: Partial<Presenca>): Promise<Presenca | null>;
}
