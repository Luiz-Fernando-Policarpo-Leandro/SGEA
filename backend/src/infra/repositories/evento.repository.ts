...
'INSERT INTO eventos (nome, instituicao, modalidade, dataInicio, dataFim, status) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *',
...
const { nome, instituicao, modalidade, dataInicio, dataFim, status } = data
const result = await pool.query(
'UPDATE eventos SET nome=$1, instituicao=$2, modalidade=$3, dataInicio=$4, dataFim=$5, status=$6 WHERE id=$7 RETURNING *',
