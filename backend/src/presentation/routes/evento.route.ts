...
router.post('/eventos', authMiddleware, roleMiddleware(['coordenador', 'administrador']), controller.create)
router.put('/eventos/:id', authMiddleware, roleMiddleware(['coordenador', 'administrador']), controller.update)
router.delete('/eventos/:id', authMiddleware, roleMiddleware(['administrador']), controller.remove)
