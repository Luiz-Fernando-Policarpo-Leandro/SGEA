...
router.get('/coordenadores', authMiddleware, roleMiddleware(['administrador']), controller.list)
router.get('/coordenadores/:id', authMiddleware, roleMiddleware(['administrador']), controller.get)
router.delete('/coordenadores/:id', authMiddleware, roleMiddleware(['administrador']), controller.remove)
