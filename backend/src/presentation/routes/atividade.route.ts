...
router.get('/atividades/evento/:evento_id', authMiddleware, controller.listByEvento)
router.get('/atividades/:id', authMiddleware, controller.get)
router.post('/atividades', authMiddleware, roleMiddleware(['coordenador', 'administrador']), controller.create)
router.put('/atividades/:id', authMiddleware, roleMiddleware(['coordenador', 'administrador']), controller.update)
router.delete('/atividades/:id', authMiddleware, roleMiddleware(['administrador']), controller.remove)
