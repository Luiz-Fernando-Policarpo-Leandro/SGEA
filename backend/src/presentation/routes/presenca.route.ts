...
export const createPresencaRouter = (
  ...
  router.get(
    "/presencas/participante/:participante_id",
    authMiddleware,
    controller.listByParticipante,
  );
  router.get(
    "/presencas/atividade/:atividade_id",
    authMiddleware,
    roleMiddleware(["coordenador", "administrador"]),
    controller.listByAtividade,
  );
  router.get(
    "/presencas/:participante_id/:atividade_id",
    authMiddleware,
    controller.get,
  );
  router.put(
