...
router.get('/participantes', authMiddleware, roleMiddleware(['coordenador', 'administrador']), controller.list)
router.get('/participantes/:id', authMiddleware, controller.get)
router.put('/participantes/:id', authMiddleware, roleMiddleware(['coordenador', 'administrador']), controller.update)
router.delete('/participantes/:id', authMiddleware, roleMiddleware(['administrador']), controller.remove)
